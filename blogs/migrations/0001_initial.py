# Generated by Django 4.0.6 on 2022-09-27 01:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main_image', models.ImageField(upload_to='main_imaages/', verbose_name='main image')),
                ('banner', models.ImageField(upload_to='banners/', verbose_name='banner')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created_at')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='posts', to='blogs.authormodel')),
